...
if ( ! class_exists( 'EldonCore_WooCommerce_YITH_Wishlist' ) ) {
	class EldonCore_WooCommerce_YITH_Wishlist {
		...
		/**
		 * @return EldonCore_WooCommerce_YITH_Wishlist
		 */
		...
		function change_templates_position() {
			...
			add_action( 'eldon_action_product_list_item_additional_image_content', 'eldon_core_get_yith_wishlist_shortcode' );
			add_action( 'eldon_core_action_product_list_item_additional_image_content', 'eldon_core_get_yith_wishlist_shortcode' );
		}
	...
	EldonCore_WooCommerce_YITH_Wishlist::get_instance();
}
