...
if ( ! function_exists( 'eldon_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function eldon_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'EldonCore_Dripicons_Icon_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'eldon_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EldonCore_Dripicons_Icon_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'eldon_core_filter_dripicons_specific_icons',
				array(
