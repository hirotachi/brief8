...
if ( ! function_exists( 'eldon_core_add_linea_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function eldon_core_add_linea_icons_to_collection( $icons ) {
		$icons[] = 'EldonCore_Linea_Icons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'eldon_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class EldonCore_Linea_Icons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'eldon_core_filter_linea_specific_icons',
				array(
