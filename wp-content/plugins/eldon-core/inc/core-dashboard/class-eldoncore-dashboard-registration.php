...
if ( class_exists( 'EldonCore_Dashboard_Rest_API' ) ) {
	class EldonCore_Dashboard_Registration extends EldonCore_Dashboard_Rest_API {
		...
		/**
		 * @return EldonCore_Dashboard_Rest_API|EldonCore_Dashboard_Registration
		 */
		...
		public function register_rest_api_route() {
			...
			register_rest_route(
				...
				array(
					...
					'callback'            => array( EldonCore_Dashboard::get_instance(), 'purchase_code_registration' ),
	...
	EldonCore_Dashboard_Registration::get_instance();
}
