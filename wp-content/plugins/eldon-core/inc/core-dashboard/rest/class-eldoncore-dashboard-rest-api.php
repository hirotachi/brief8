...
if ( ! class_exists( 'EldonCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class EldonCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'eldon_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return EldonCore_Dashboard_Rest_API
		 */
	...
	EldonCore_Dashboard_Rest_API::get_instance();
}
