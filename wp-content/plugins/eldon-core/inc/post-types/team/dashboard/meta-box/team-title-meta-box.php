...
if ( ! function_exists( 'eldon_core_add_team_title_meta_boxes' ) ) {
	/**
	 * Function that add title meta boxes for team module
	 */
	function eldon_core_add_team_title_meta_boxes( $page, $has_single ) {
	...
	add_action( 'eldon_core_action_after_team_meta_box_map', 'eldon_core_add_team_title_meta_boxes', 10, 2 );
}
