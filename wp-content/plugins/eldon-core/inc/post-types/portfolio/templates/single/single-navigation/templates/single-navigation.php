<?php
$is_enabled = eldon_core_get_post_value_through_levels( 'qodef_portfolio_enable_navigation' );

if ( 'yes' === $is_enabled ) {
	$through_same_category = 'yes' === eldon_core_get_post_value_through_levels( 'qodef_portfolio_navigation_through_same_category' );
	?>
	<div id="qodef-single-portfolio-navigation" class="qodef-m">
		<div class="qodef-m-inner">
			...
			$post_navigation        = array(
				'prev'      => array(
					'label' => '<span class="qodef-m-nav-label">' . esc_html__( 'Prev', 'eldon-core' ) . '</span>',
					'icon'  => eldon_core_get_svg_icon( 'portfolio-nav-arrow-left', 'qodef-m-nav-icon' ),
				),
				'back-link' => array(),
				'next'      => array(
					'label' => '<span class="qodef-m-nav-label">' . esc_html__( 'Next', 'eldon-core' ) . '</span>',
					'icon'  => eldon_core_get_svg_icon( 'portfolio-nav-arrow-right', 'qodef-m-nav-icon' ),
				),
			);
			...
			if ( '' !== $back_to_link ) {
				$post_navigation['back-link'] = array(
					...
					'icon'    => eldon_core_get_svg_icon( 'portfolio-nav-back-link' ),
				);
			}
