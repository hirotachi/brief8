...
if ( ! function_exists( 'eldon_core_add_mobile_logo_options' ) ) {
	/**
	 ...
	 */
	function eldon_core_add_mobile_logo_options( $page, $mobile_header_tab ) {
		...
		if ( $page ) {
			...
			$mobile_header_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Mobile Header Logo Options', 'eldon-core' ),
					'description' => esc_html__( 'Set options for mobile headers', 'eldon-core' ),
				)
			);
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Height', 'eldon-core' ),
					'description' => esc_html__( 'Enter mobile logo height', 'eldon-core' ),
					'args'        => array(
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Mobile Logo Padding', 'eldon-core' ),
					'description' => esc_html__( 'Enter mobile logo padding value (top right bottom left)', 'eldon-core' ),
				)
			);
			...
			$mobile_header_tab->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo Source', 'eldon-core' ),
					'options'       => array(
			...
			$logo_image_section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Mobile Logo - Main', 'eldon-core' ),
					'description'   => esc_html__( 'Choose main mobile logo image', 'eldon-core' ),
			...
			$logo_image_section->add_field_element(
				array(
					'field_type'  => 'select',
					'name'        => 'qodef_mobile_logo_animated',
					'title'       => esc_html__( 'Animated Mobile Logo', 'eldon-core' ),
					'options'    => eldon_core_get_select_type_options_pool( 'yes_no', false ),
					'description' => esc_html__( 'Enable Animated Mobile Logo', 'eldon-core' ),
				)
			);

			// Hook to include additional options after section part
			do_action( 'eldon_core_action_after_mobile_logo_image_section_options_map', $page, $mobile_header_tab, $logo_image_section );
			...
			// Hook to include additional options after section part
			do_action( 'eldon_core_action_after_mobile_logo_svg_path_section_options_map', $page, $mobile_header_tab, $logo_svg_path_section );
			...
			// Hook to include additional options after section part
			do_action( 'eldon_core_action_after_mobile_logo_textual_section_options_map', $page, $mobile_header_tab, $logo_textual_section );

			do_action( 'eldon_core_action_after_mobile_logo_options_map', $page );
		}
	}

	add_action( 'eldon_core_action_after_header_logo_options_map', 'eldon_core_add_mobile_logo_options', 10, 2 );
}
