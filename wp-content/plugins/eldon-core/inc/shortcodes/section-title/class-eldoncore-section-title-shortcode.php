...
if ( ! function_exists( 'eldon_core_add_section_title_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function eldon_core_add_section_title_shortcode( $shortcodes ) {
		$shortcodes[] = 'EldonCore_Section_Title_Shortcode';

		return $shortcodes;
	}

	add_filter( 'eldon_core_filter_register_shortcodes', 'eldon_core_add_section_title_shortcode' );
}

if ( class_exists( 'EldonCore_Shortcode' ) ) {
	class EldonCore_Section_Title_Shortcode extends EldonCore_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( ELDON_CORE_SHORTCODES_URL_PATH . '/section-title' );
			$this->set_base( 'eldon_core_section_title' );
			$this->set_name( esc_html__( 'Section Title', 'eldon-core' ) );
			$this->set_description( esc_html__( 'Shortcode that adds section title element', 'eldon-core' ) );
			...
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'link',
					'title'      => esc_html__( 'Title Custom Link', 'eldon-core' ),
				)
			);
			$this->set_option(
				array(
		...
		public function render( $options, $content = null ) {
			...
			return eldon_core_get_template_part( 'shortcodes/section-title', 'templates/section-title', '', $atts );
		}
