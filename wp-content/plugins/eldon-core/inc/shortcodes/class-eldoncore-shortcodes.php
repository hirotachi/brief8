...
if ( ! class_exists( 'EldonCore_Shortcodes' ) ) {
	class EldonCore_Shortcodes {
		...
		function init() {
			...
			include_once ELDON_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once ELDON_CORE_SHORTCODES_PATH . '/class-eldoncore-shortcode.php';
			include_once ELDON_CORE_SHORTCODES_PATH . '/class-eldoncore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'eldon_core_filter_register_shortcodes', $shortcodes = array() );
	...
	EldonCore_Shortcodes::get_instance();
}
