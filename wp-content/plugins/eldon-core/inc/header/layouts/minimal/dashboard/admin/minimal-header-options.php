...
if ( ! function_exists( 'eldon_core_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function eldon_core_add_minimal_header_options( $page, $general_header_tab ) {
	...
	add_action( 'eldon_core_action_after_header_options_map', 'eldon_core_add_minimal_header_options', 10, 2 );
}
