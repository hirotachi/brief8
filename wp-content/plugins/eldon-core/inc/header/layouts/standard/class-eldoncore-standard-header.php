...
class EldonCore_Standard_Header extends EldonCore_Header {
	...
	/**
	 * @return EldonCore_Standard_Header
	 */
	...
	function get_menu_position() {
		return eldon_core_get_post_value_through_levels( 'qodef_standard_header_menu_position' );
	}
