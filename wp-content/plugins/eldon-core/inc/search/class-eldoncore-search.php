...
abstract class EldonCore_Search {
	private $search_layout;

	public function __construct() {
		add_action( 'wp', array( $this, 'set_variables' ), 11 ); //after eldon_core_search_include_layout
	...
	function set_variables() {
		$this->set_search_layout( EldonCore_Headers::get_instance()->get_header_object()->get_search_layout() );
	}
