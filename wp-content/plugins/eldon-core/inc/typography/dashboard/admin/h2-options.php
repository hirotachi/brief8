...
if ( ! function_exists( 'eldon_core_add_h2_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function eldon_core_add_h2_typography_options( $page ) {
		...
		if ( $page ) {
			$h2_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h2',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H2 Typography', 'eldon-core' ),
					'description' => esc_html__( 'Set values for Heading 2 HTML element', 'eldon-core' ),
				)
			);
	...
	add_action( 'eldon_core_action_after_typography_options_map', 'eldon_core_add_h2_typography_options' );
}
